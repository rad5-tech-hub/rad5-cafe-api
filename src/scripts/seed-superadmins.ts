...
const ADMINS = [
  { email: 'claire@rad5.com.ng', name: 'Claire Admin' },
  { email: 'ikechukwu@rad5.com.ng', name: 'Ikechukwu Admin' },
  { email: 'igwe@rad5.com.ng', name: 'Igwe Admin' },
];

const DEFAULT_PASSWORD = 'Rad5Super@Admin2026';
